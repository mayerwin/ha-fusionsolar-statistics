...
### Fixed
- **The Documentation link on the card picker entry was dead.** The file header and the
  `customCards` `documentationURL` both read `mayerwin/fusionsolar-statistics`; the repository
  is `mayerwin/ha-fusionsolar-statistics`.
